...
LINEEND=" \\"
COUNT=`wc -l ../m7c-common/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../m7c-common/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
...
LINEEND=" \\"
COUNT=`wc -l ../m7c-common/common-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../m7c-common/common-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
